...
public class TestReportXML {
	...
	public void registrarUnitTestEnXML(ResultType type, String resultMessage){
		//Aca va la parte en que se genera el texto de XML para el UnitTestResult
		registrarEstadistica(type);
	}

	public void registrarTestCollectionEnXML(String nombreEncadenado, String message){
