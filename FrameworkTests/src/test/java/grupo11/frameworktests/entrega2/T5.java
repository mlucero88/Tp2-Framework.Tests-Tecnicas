...
public class T5 extends UnitTest {
	public final static String FIXTURE_SETUP_VAR_NAME = "setupT5";
	public final static Object FIXTURE_SETUP_VAR_VALUE = new Integer(5);
	public final static String FIXTURE_TEARDOWN_VAR_NAME = "teardownT5";
	public final static Object FIXTURE_TEARDOWN_VAR_VALUE = new Boolean(false);
	public final static String FIXTURE_TEST_VAR_NAME = "testT5";
	public final static Object FIXTURE_TEST_VAR_VALUE = new String("testingT5");

	public T5(String testName) {
		super(testName);
	}
