...
public class T7 extends UnitTest {
	public final static String FIXTURE_SETUP_VAR_NAME = "setupT7";
	public final static Object FIXTURE_SETUP_VAR_VALUE = new Integer(7);
	public final static String FIXTURE_TEARDOWN_VAR_NAME = "teardownT7";
	public final static Object FIXTURE_TEARDOWN_VAR_VALUE = new Boolean(false);
	public final static String FIXTURE_TEST_VAR_NAME = "testT7";
	public final static Object FIXTURE_TEST_VAR_VALUE = new String("testingT7");

	public T7(String testName) {
		super(testName);
	}
